...
//   41        |10         |  12
    ...
    private volatile static BasicEntityIdGenerator basicEntityIdGenerator;
    ...
    public static BasicEntityId decodeLongId(long id){
        BasicEntityId b = new BasicEntityId();
        b.setTimestamp((id>>22)+1288834974657L);
        b.setCenterId((id- ((id>>22)<<22))>>12);
        long centerId = (id- ((id>>22)<<22));
        b.setSeqId((centerId - (centerId>>12<<12)));
        return b;
    }
